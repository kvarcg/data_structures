...
namespace DS {
    ...
    void compareElements(const std::vector<GenericTestObject>& vector, const LinkedList<GenericTestObject>& list) {
    ...
    void testBase(int32_t num_elements) {
        // test empty list
        LinkedList<GenericTestObject> list;
        ...
        // test copy
        LinkedList<GenericTestObject> list_clone(list);
        list.destroy();
        compareElements(vector, list_clone);

        // test assignment
        LinkedList<GenericTestObject> list_clone2;
    ...
    void testOperations(int32_t num_elements) {
        ...
        {
            LinkedList<GenericTestObject> list;
            LinkedList<GenericTestObject> list_reversed = list.reverse();
            std::vector<GenericTestObject> vector;
